...
def main():
    ...
    asr_model = nemo_asr.models.EncDecSpeakerLabelModel.restore_from(r"C:\DovaTuum\MyJavaProjects\SpeakerRecognitionScripts\pretrained\speakerverification_en_titanet_large.nemo")
